...
type TemplateService interface {
	...
	SearchTemplateByName(ctx context.Context, tplName string) (*gorm.DB, error)
}
...
func (t *templateService) ListTemplate(ctx context.Context) (*gorm.DB, error) {
...
func (t *templateService) SearchTemplateByName(ctx context.Context, tplName string) (*gorm.DB, error) {
